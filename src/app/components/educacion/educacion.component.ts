  ...
  constructor() {
    this.misEstudios=[
     /*  new Educacion (0,0,"carrera", "institucion", "fecha_inicio","fecha_fin", "tipo_Educacion", "estado" ), */
      ...
      new Educacion (3,0,"MeTCaMP React", "MeT", "Agosto 2021","Septiembre 2022", "Bootcamp", "Finalizado" ),
      new Educacion (4,0,"HTML CSS y JavaScript", "Platzi", "Marzo 2022","Marzo 2022", "Curso", "Finalizado" ),
      new Educacion (5,0,"111mil Programadores", "INET", "Octubre 2018","", "Capacitación", "Incompleto" ),
      new Educacion (6,0,"Ingenieria", "UTN", "Enero 2001","", "Universitaria", "Abandonada" )
    ]
  }
